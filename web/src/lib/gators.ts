...
export const GATORS_PRICE_CENTS = 10000; // $100
export const GATORS_THUMBNAIL_URL = "/products/gators/gators-mint-marble.jpg";

export const GATORS_DESCRIPTION_SHORT =
  "Engineered for all-day clog comfort, built to last. Inspired by the alligator — chunky cushion, easy slip-on.";

export const GATORS_DESCRIPTION =
  "Engineered for all-day clog comfort, built to last. Meet The Gators 🐊 — a comfort-first clog with serious bite. Named for the alligator, these easy slip-ons blend a rounded closed toe, open back, and a thick cushioned platform so every step feels soft and supported. Clogs are built for all-day wear: slide them on, stay comfortable, and go. The Gators take that classic clog comfort and give it a gator attitude — grippy sole energy, a breathable mesh upper, and a silhouette that looks as bold as it feels. Limited run — low stock.";

export const GATORS_HOW_ITS_MADE =
  "Each pair of The Gators is 3D-printed as a one-piece comfort clog: a flexible mesh upper for breathability and a thick, ribbed midsole for cushion and grip. The open-back clog shape makes them easy on and easy off, while the closed toe keeps you covered. Printed to order in your color, then finished for daily wear.";
...
/** Low stock — limited pairs available. */
