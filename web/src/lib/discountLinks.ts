...
import { getInfluencerLinkForCode, buildInfluencerDiscountUrl } from "@/lib/influencerLinks";
...
/** Permanent public auto-apply link for an influencer bio, e.g. https://voronyz.com/aryan */
