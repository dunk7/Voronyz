...
export const metadata: Metadata = {
  ...
  description:
    "Shop Voronyz Apparel by type: shirts, sweaters, socks, shorts, sweats, pants, outerwear, scarves — plus accessories like hats, water bottles, cool shades, lattice insoles, jewelry, and more.",
};
