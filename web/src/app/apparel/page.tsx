...
export const metadata: Metadata = {
  ...
  description:
    "Shop Voronyz Apparel by type: shirts, sweaters, socks, shorts, sweats, pants, outerwear, hats, scarves, bottles — plus accessories like cool shades, jewelry, and more.",
};
