...
export const metadata: Metadata = {
  ...
  description:
    "Shop Voronyz Apparel by type: shirts, sweaters, socks, shorts, pants, outerwear, scarves — plus accessories like hats, bottles, cool shades, lattice insoles, jewelry, and more.",
};
