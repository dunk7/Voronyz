...
function pendingPayload(
  ...
  return {
    ...
    subtotalUsd: metadata?.subtotalUsd,
    nanoDiscountCents: metadata?.nanoDiscountCents,
    nanoDiscountUsd: metadata?.nanoDiscountUsd,
    nanoDiscountRate: metadata?.nanoDiscountRate,
