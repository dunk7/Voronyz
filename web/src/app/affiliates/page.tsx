      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-neutral-50 to-neutral-100">
        ...
        <div className="relative container py-24 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              href="#how-it-works"
              className="btn-shimmer inline-flex items-center justify-center gap-2 px-8 py-4 bg-black text-white rounded-full hover:bg-neutral-800 transition-colors font-medium"
            >
              See how it works
            </a>
            <a
