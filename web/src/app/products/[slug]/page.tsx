        ...
        <div className="mt-12">
          ...
          <FAQ
            items={isDragonfly ? [
              ...
              { q: "What sizes are available?", a: "Most pieces run XS–XXL. Hats, scarves, bottles, cool shades, jewelry, keychains, lace locks, and drone parts are One Size. Socks use S–XL." },
